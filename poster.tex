...
\hl{Sky/XY Correlation} and \hl{Sky Vector} layers:
...
\begin{textblock}{0.66}(0,0.96)
\txtAcknowledgements
\end{textblock}

\begin{textblock}{0.33}(0.67,0.96)
\txtDiy
\end{textblock}
...
\begin{textblock}{1}(0,1.035)
{\color{grey}
 ADASS XXVIII, College Park, MD, USA, November 2018
 \hfill
 \verb|$Id: poster.tex,v 1.22 2018/10/24 21:21:22 mbt Exp $|
}
\end{textblock}
